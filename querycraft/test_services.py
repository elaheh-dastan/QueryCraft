...
class TestCleanSQLQuery(TestCase):
    ...
    def test_query_with_markdown_code_block(self):
    ...
    def test_query_with_markdown_no_language_identifier(self):
    ...
    def test_query_with_uppercase_sql_identifier(self):
        """Test markdown with uppercase SQL identifier"""
        sql = "```SQL\nSELECT * FROM querycraft_product\n```"
        result = SQLAgent._clean_sql_query(sql)
        self.assertEqual(result, "SELECT * FROM querycraft_product")

    def test_query_with_extra_text_before(self):
    ...
    def test_query_with_extra_text_after(self):
    ...
    def test_multiline_query_in_markdown(self):
    ...
    def test_query_with_comments_in_markdown(self):
